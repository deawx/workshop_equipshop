...
class MY_Model extends CI_Model {
  ...
  public function search_like($conditions=NULL,$table_name=NULL,$limit=NULL,$offset=0,$order_by=NULL)
	{
    if ($table_name === NULL)
  ...
  public function search_where($conditions=NULL,$table_name=NULL,$limit=NULL,$offset=0,$order_by=NULL)
  {
    if ($table_name === NULL)
      $table_name = $this->table_name;
