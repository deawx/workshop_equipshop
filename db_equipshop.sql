...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2019 at 07:20 PM
...
CREATE TABLE `tb_order_detail_data` (
  ...
  `reserve_name` varchar(100) NOT NULL COMMENT 'ข้อมูลผู้เกี่ยวข้อง',
  `reserve_phone` varchar(10) NOT NULL COMMENT 'ข้อมูลเบอร์โทรศัพท์ผู้เกี่ยวข้อง',
...
INSERT INTO `tb_order_detail_data` (`id`, `order_detail_id`, `qr_code`, `picture`, `firstname`, `lastname`, `id_card`, `phone`, `reserve_name`, `reserve_phone`, `gender`, `birthdate`, `blood`, `weight`, `height`, `nationality`, `religion`, `latitude`, `longtitude`, `hospital`) VALUES
...
CREATE TABLE `tb_scan` (
  ...
  `mobile_number` varchar(10) NOT NULL COMMENT 'หมายเลขโทรศัพท์มือถือ',
...
INSERT INTO `tb_scan` (`id`, `qr_code`, `id_card`, `mobile_number`, `datetime`) VALUES
...
(27, '5-1234567890123', '1111111111111', '', '2019-04-23 21:04:23'),
(28, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:16:02'),
(29, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:16:30'),
(30, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:28:37'),
(31, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:28:53'),
(32, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:28:59'),
(33, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:29:13'),
(34, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:29:16'),
(35, '5-1234567890123', '1231231231231', '1231231231', '2019-04-23 22:29:39');
...
--
ALTER TABLE `tb_bank`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'รหัสธนาคาร', AUTO_INCREMENT=2;
...
--
ALTER TABLE `tb_scan`
  MODIFY `id` int(6) NOT NULL AUTO_INCREMENT COMMENT 'รหัสการแสกน', AUTO_INCREMENT=36;
